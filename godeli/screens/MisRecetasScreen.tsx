...
const MisRecetasScreen = (props: any) => {
  return (
    <View style={
      ...
      <MaterialCommunityIcons name="face-man-profile" size={50} color="#FFCE80" style={screenMisRecetasStyles.profileStyle} onPress={()=>props.navigation.navigate('ProfileScreen')} />
      ...
      <TouchableOpacity onPress={onButtonPress}>
        ...
        onPress={()=>props.navigation.navigate('AgregarRecetaScreen')}
        />
      </TouchableOpacity>
    </View>
  )
